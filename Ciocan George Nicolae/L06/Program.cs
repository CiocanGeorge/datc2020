    ...
    class Program
	    {
	        ...
	        static async Task Initialize()
	        {
	            ...
	            + "AccountName=datc2020ciocan;"
	            + "AccountKey=fvasM+33dEPAmTthxdoD4PPbN1gPBMYmBa+umXvZuITyx/aawaORDg+jVYkzS0y9Z18gq1OMAUNobAaHJeamiA==;"
	        ...
	        private static async Task AdaugareStudent()
	        {
	            ...
	            if(stud == null)
	            {
					...
					QueueClient queueClient= new QueueClient("DefaultEndpointsProtocol=https;AccountName=datc2020ciocan;AccountKey=fvasM+33dEPAmTthxdoD4PPbN1gPBMYmBa+umXvZuITyx/aawaORDg+jVYkzS0y9Z18gq1OMAUNobAaHJeamiA==;EndpointSuffix=core.windows.net","stundents-queue");
